...
FORCE_SUB_CHANNEL5 = int(os.environ.get("FORCE_SUB_CHANNEL5", "0"))#put 0 to disable
FORCE_SUB_CHANNEL6 = int(os.environ.get("FORCE_SUB_CHANNEL6", "0"))#put 0 to disable
FORCE_SUB_CHANNEL7 = int(os.environ.get("FORCE_SUB_CHANNEL7", "0"))#put 0 to disable
FORCE_SUB_CHANNEL8 = int(os.environ.get("FORCE_SUB_CHANNEL8", "0"))#put 0 to disable
